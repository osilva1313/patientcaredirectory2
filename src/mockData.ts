...
export const agencies: Agency[] = [
  {
    id: '1',
    name: 'Astella Home Health & Hospice',
    description: 'Services Provided: Home Health, Hospice, Physical Therapy, Occupational Therapy, Speech Therapy, Cardiac Care, Diabetic Management, Diagnosis Education, IV Therapy, Medication Management, Pulmonary Care',
    logo: 'https://raw.githubusercontent.com/osilva1313/patientcaredirectory2/main/public/astella-logo.png',
    address: '',
    phone: '(855) 463-4584',
    fax: '(855) 329-4667',
    website: 'https://www.astellahealth.com',
    featured: true,
    serviceTypes: ['Home Health', 'Hospice', 'Physical Therapy', 'Occupational Therapy', 'Speech Therapy', 'Cardiac Care', 'Diabetic Management', 'Diagnosis Education', 'IV Therapy', 'Medication Management', 'Pulmonary Care'],
    counties: [
      'Brooks', 'Kenedy', 'Kleberg', 'Jim Wells', 'Duval', 'McMullen', 'Live Oak',
      'Nueces', 'San Patricio', 'Aransas', 'Refugio', 'Bee', 'Goliad', 'Victoria',
      'Atacosa', 'Wilson', 'Bexar', 'Medina', 'Guadalupe', 'Comal', 'Kendall', 'Bandera'
    ],
    insuranceAccepted: [
      'Traditional Medicare', 'Aetna Medicare', 'Amerigroup', 'United Healthcare Medicare',
      'BCBS Medicare', 'Cigna Health Springs', 'Christus Health Medicare',
      'Humana PPO', 'Humana Medicare', 'Wellmed'
    ]
  },
  {
    id: '2',
